...
class RequestTicket(TimeAuditModel):
...
#    ticket = models.ForeignKey(Ticket, on_delete=models.CASCADE)
   ...
   approval_from = models.ForeignKey(User, on_delete=models.CASCADE, related_name="approval_from"
   )
...
class TicketAvailability(TimeAuditModel):
